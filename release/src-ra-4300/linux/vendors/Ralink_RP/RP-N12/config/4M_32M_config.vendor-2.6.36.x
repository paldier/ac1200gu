...
# CONFIG_LIB_ALSA_FORCE is not set
# CONFIG_LIB_AO_FORCE is not set
# CONFIG_LIB_GUPNPAV_FORCE is not set
...
# CONFIG_RALINKAPP_LONG_LOOP is not set
...
# ASUS Application
#
# CONFIG_ASUS_NTFS3G is not set
CONFIG_ASUS_SHARED=y
CONFIG_ASUS_RC=y
CONFIG_ASUS_NVRAM=y
CONFIG_ASUS_INFOSVR=y
CONFIG_ASUS_NETWORKMAP=y
CONFIG_ASUS_HTTPD=y
CONFIG_ASUS_WWW=y
CONFIG_ASUS_APCLI_WPS=y
# CONFIG_ASUS_I2C_CTRL is not set
# CONFIG_DPROXY is not set
# CONFIG_PPPOE_RELAY is not set
# CONFIG_TC is not set
CONFIG_UDHCPD=y
# CONFIG_BPALOGIN is not set
# CONFIG_PPPD is not set
# CONFIG_EZ_IPUPDATE is not set
CONFIG_IGMPPROXY=y
# CONFIG_L2TP is not set
# CONFIG_PPTP_CLIENT is not set
# CONFIG_LPRNG is not set
# CONFIG_LIBUSB is not set
# CONFIG_U2EC is not set

#
# Audio Application
#
# CONFIG_ASUS_AUDIO is not set
# CONFIG_ASUS_PLAYER is not set
# CONFIG_USER_ALSA_UTILS is not set
# CONFIG_USER_MPG123 is not set
# CONFIG_USER_M3PLAYER is not set
# CONFIG_USER_SHAIRPORT is not set
