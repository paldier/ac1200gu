...
CONFIG_LIB_ALSA_FORCE=y
CONFIG_LIB_AO_FORCE=y
CONFIG_LIB_GUPNPAV_FORCE=y
...
# CONFIG_RALINKAPP_QDMA is not set
...
#
CONFIG_ASUS_AUDIO=y
CONFIG_ASUS_PLAYER=y
CONFIG_USER_ALSA_UTILS=y
CONFIG_LIB_ALSA_FORCE=y
CONFIG_USER_MPG123=y
CONFIG_USER_M3PLAYER=y
CONFIG_LIB_GUPNPAV_FORCE=y
CONFIG_USER_SHAIRPORT=y
CONFIG_LIB_AO_FORCE=y
CONFIG_USER_OPENSSL=y
CONFIG_USER_HOWL=y
