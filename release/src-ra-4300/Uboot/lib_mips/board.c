...
/*config bootdelay via environment parameter: bootdelay */
	...
	#if defined (MT7621_ASIC_BOARD) ||defined (MT7620_FPGA_BOARD) || defined(MT7620_ASIC_BOARD)
	RALINK_REG(0xb0000060) &= ~(1 << 20);       //set PA_G_GPIO_MODE to normal mode
	#endif
