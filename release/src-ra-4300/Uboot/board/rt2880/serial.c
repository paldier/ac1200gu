...
#elif	defined(RT2883_FPGA_BOARD) || \
	defined(RT3052_FPGA_BOARD) || \
	defined(RT3352_FPGA_BOARD) || \
	defined(RT3883_FPGA_BOARD) || \
	defined(RT5350_FPGA_BOARD) || \
	defined(RT6855_FPGA_BOARD) || \
	defined(MT7620_FPGA_BOARD) || \
	defined(MT7621_FPGA_BOARD)
...
#error undef SDR or DDR
	...
	mips_bus_feq = cpu_clock / 2;
#elif defined(RT6855A_ASIC_BOARD) || defined(RT6855A_FPGA_BOARD) || 	defined(MT7628_ASIC_BOARD)
